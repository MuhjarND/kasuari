<?php
$sql = "SELECT * FROM master_variabel WHERE var_id=$id";
...
<div class="w3-container" id="div_modal_detail"><span class="w3-right"><button class="w3-btn w3-round w3-red w3-small" onclick="tutup_modal()">X</button>
	...
	<input name="aksi" id="aksi" type="hidden" value="<?php echo base64_encode("variabel_simpan_edit")?>">
	<input name="var_id" id="var_id" type="hidden" value="<?php echo $var_id?>">
	...
	<p>Bentuk Inputan<br>
		<select class="w3-select w3-border w3-white" id="var_jenis" name="var_jenis">
			<option value="<?php echo $var_jenis?>" selected="selected"><?php echo $var_jenis?></option>
			<option value="text">text</option><option value="textarea">textarea</option>		</select>
	</p> 
	<p>Model<br>
		<span id="model">
			<select class="w3-select w3-border w3-white" name="var_model" id="var_model" onchange="pilih_model_variabel(this.value)"><option value="<?php echo $var_model?>" selected="selected"><?php echo $var_model?></option>
	...
	<p><label>Tabel</label>
		<select name="var_tabel" id="var_tabel" class="w3-select w3-border w3-white">
			<option value=""></option>
			<option value="<?php echo $var_tabel?>" selected="selected"><?php echo $var_tabel?></option>
	...
	<p>Field<br>
		<select name="var_field" id="var_field" class="w3-select w3-border w3-white">
			<option value="<?php echo $var_field?>" selected="selected"><?php echo $var_field?></option>
			<option  value=""></option>
...
<option value="tanggal_cabut">tanggal_cabut</option>
	...
	<p><label>Nama Fungsi</label>
		<select class="w3-select w3-border w3-white" id="var_fungsi_nama" name="var_fungsi_nama">
			<option value="<?php echo $var_fungsi_nama?>" selected="selected"><?php echo $var_fungsi_nama?></option>
			<option value=""></option>
