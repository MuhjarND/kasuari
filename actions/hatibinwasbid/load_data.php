...
$sql = "SELECT hatibinwasbid.*, convert_tanggal_indonesia(tgl_mulai) AS mulai, convert_tanggal_indonesia(tgl_sampai) AS sampai FROM hatibinwasbid ORDER BY id DESC";
