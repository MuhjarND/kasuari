...
<div class="app-content-header">
  <div class="container-fluid">
    <div class="kasuari-page-title">
      <div>
        <h1>Hatibinwasda</h1>
        <p>Laporan Pengawasan Hakim Tinggi Pengawas Daerah — PTA Papua Barat.</p>
      </div>
  ...
  <div class="container-fluid">
    <div class="kasuari-panel">
      ...
      <div class="kasuari-panel-title">
        <h3><i class="bi bi-clipboard2-data me-2" style="color:#3b82f6;"></i>Daftar Kegiatan Pengawasan Daerah</h3>
        ...
        <div class="modal-body" style="padding:22px;">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="satuan_kerja" name="satuan_kerja"
                   list="list_pa" placeholder="Pilih atau ketik nama PA" required autocomplete="off">
            <datalist id="list_pa">
              <option value="PA Manokwari">
              <option value="PA Sorong">
              <option value="PA Fakfak">
              <option value="PA Kaimana">
              <option value="PA Sorong Selatan">
              <option value="PA Waisai">
              <option value="PA Bintuni">
              <option value="PA Ransiki">
            </datalist>
          </div>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.getElementById('formKegiatan').addEventListener('submit', function (e) {
    ...
    fetch('actions/hatibinwasda/proses.php', { method: 'POST', body: new FormData(this) })
      .then(r => r.text())
      .then(data => {
...
function loadData() {
  fetch('actions/hatibinwasda/load_data.php')
    .then(r => r.text())
    .then(data => {
...
function tambahData() {
  ...
  document.getElementById('tim').value = "Ketua Tim: \nAnggota (Hakim Tinggi): \nSekretaris/Pendamping: ";
...
function editData(id) {
  ...
  fd.append('id', id);
  fetch('actions/hatibinwasda/get_data.php', { method: 'POST', body: fd })
    .then(r => r.json())
    .then(data => {
...
function hapusData(id) {
  ...
  fd.append('id', id);
  fetch('actions/hatibinwasda/proses.php', { method: 'POST', body: fd })
    .then(r => r.text())
